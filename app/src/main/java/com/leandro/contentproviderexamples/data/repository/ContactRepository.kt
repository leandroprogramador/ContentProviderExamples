...
open class ContactRepository @Inject constructor(private val contentResolver: ContentResolver) : ContactRepositoryInterface {
    ...
    override fun getContacts(): ContactResult {
        return try {
            ...
            ContactResult.Error("Permissão negada")
        } catch (e: Exception) {
            ContactResult.Error("Erro ao carregar contatos")
        }
    }
}